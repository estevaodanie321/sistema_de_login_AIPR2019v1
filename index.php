...
<body class="bg-dark">
  ...
  <main class="container mt-4">
    ...
    <section class="row">
      <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixadeLogin">
        <h2 class="text-center mt-2">Entrada no sistema</h2>
          <form action="#" id="formLogin" class="p-2">
            ...
            <div class="form-group">
              ...
              placeholder="Nome do Usário" required>
            </div>
            ...
            <div class="form-group">
            <input type="submit" value="::Entrar::" name="btnEntrar" id="btnEntrar" class="btn btn-primary btn btn">
